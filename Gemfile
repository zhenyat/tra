...
gem 'bootstrap', '~> 4.0.0.beta2.1'             # Bootstrap 4:  https://github.com/twbs/bootstrap-rubygem
...
# Heroku
#group :production do
#  gem 'rails_12factor'    # Not needed anymore. See:  https://devcenter.heroku.com/articles/getting-started-with-rails5#local-workstation-setup
#end
